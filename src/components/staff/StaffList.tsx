              ...
              >
                ...
                <div className="hidden md:grid grid-cols-12 gap-6 items-center p-6">
                  ...
                  <div className="col-span-1 flex flex-col space-y-2">
                    <button
                      ...
                      className="w-full px-3 py-2 bg-gradient-to-br from-indigo-500 to-indigo-600 text-white rounded-xl hover:from-indigo-600 hover:to-indigo-700 transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105"
                      title="View Details"
                    >
                    ...
                    <button
                      ...
                      className="w-full px-3 py-2 bg-gradient-to-br from-emerald-500 to-emerald-600 text-white rounded-xl hover:from-emerald-600 hover:to-emerald-700 transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105"
                      title="Edit Staff"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                      onClick={() => {
                        console.log('🔴 DELETE BUTTON CLICKED for staff:', person.name, 'ID:', person.id || person._id)
                        onDeleteStaff(person._id || person.id)
                      }}
                      className="w-full px-3 py-2 bg-gradient-to-br from-red-500 to-red-600 text-white rounded-xl hover:from-red-600 hover:to-red-700 transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105"
                      title="Delete Staff"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="md:hidden p-3">
                  ...
                  <div className="flex space-x-1">
                    <button
                      onClick={() => onViewStaff(person)}
                      className="flex-1 px-2 py-1.5 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white rounded-md text-xs font-semibold flex items-center justify-center space-x-1 hover:from-indigo-600 hover:to-indigo-700 transition-all"
                    >
                    ...
                    <button
                      onClick={() => {
                        console.log('🔴 MOBILE DELETE BUTTON CLICKED for staff:', person.name, 'ID:', person.id || person._id)
                        onDeleteStaff(person._id || person.id)
                      }}
