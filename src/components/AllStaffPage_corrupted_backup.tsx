          ...
          <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
            ...
            <div className="mt-4 pt-4 border-t border-red-200">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div>
                  <h3 className="text-sm font-bold text-red-700">⚠️ Danger Zone</h3>
                  <p className="text-xs text-red-600">Irreversible actions - use with caution</p>
                </div>
                <button
                  onClick={clearAllData}
                  className="bg-gradient-to-r from-red-500 to-red-600 text-white px-4 py-2 rounded-lg hover:from-red-600 hover:to-red-700 transition-all duration-200 font-medium text-sm"
                >
                  🗑️ Clear All Data
                </button>
              </div>
